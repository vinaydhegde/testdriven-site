...
To add the [state](https://en.wikipedia.org/wiki/State_(computer_science%29) - i.e., the users - to the component we need to use `setState()`, which is an asynchronous function use to update state.
